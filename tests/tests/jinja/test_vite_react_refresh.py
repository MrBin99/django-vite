...
def test_vite_react_refresh_returns_script_tag(jinja_env):
...
def test_vite_react_refresh_uses_correct_settings(jinja_env, patch_settings):
    template = jinja_env.from_string(
        """
        {{ vite_react_refresh() }}
    """
...
def test_vite_react_refresh_returns_nothing_with_dev_mode_false(jinja_env):
    template = jinja_env.from_string(
        """
        {{ vite_react_refresh() }}
    """
...
def test_vite_react_refresh_url_setting(jinja_env, patch_settings):
    template = jinja_env.from_string(
        """
        {{ vite_react_refresh() }}
    """
...
def test_vite_react_refresh_uses_kwargs(jinja_env, patch_settings):
    template = jinja_env.from_string(
        """
