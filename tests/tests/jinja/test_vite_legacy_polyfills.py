...
def test_vite_legacy_polyfills_returns_nothing_with_dev_mode_on(jinja_env):
...
def test_vite_legacy_polyfills_production(jinja_env, patch_manifest_path):
    template = jinja_env.from_string(
        """
        {{ vite_legacy_polyfills() }}
    """
...
def test_vite_legacy_polyfills_custom_motif(
    jinja_env, patch_manifest_path_custom_motif
):
    template = jinja_env.from_string(
        """
        {{ vite_legacy_polyfills() }}
...
def test_vite_legacy_polyfills_nonexistent_motif(
    jinja_env, patch_manifest_path_bad_motif
):
    template = jinja_env.from_string(
        """
            {{ vite_legacy_polyfills() }}
